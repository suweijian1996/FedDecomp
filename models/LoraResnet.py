...
def conv3x3(in_planes: int, out_planes: int, stride: int = 1, groups: int = 1, dilation: int = 1, r: int = 16) -> nn.Conv2d:
...
def conv1x1(in_planes: int, out_planes: int, stride: int = 1, r: int = 16) -> nn.Conv2d:
    """1x1 convolution"""
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block: Type[Union[BasicBlock]], planes: int, blocks: int,
                    stride: int = 1, dilate: bool = False, Conv_r: int = 16) -> nn.Sequential:
